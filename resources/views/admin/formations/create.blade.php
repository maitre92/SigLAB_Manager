                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="code" id="formation_code" class="form-control" value="{{ old('code') }}" required placeholder="ex: DEV-WEB-001">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="niveau" class="form-control" value="{{ old('niveau') }}" placeholder="ex: Débutant, Intermédiaire...">
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="salle" class="form-control" value="{{ old('salle') }}" placeholder="ex: Salle A1, Zoom...">
                            </div>
                            <div class="col-md-6">
                                ...
                                <select name="formateurs[]" id="formateurs_select" class="form-control" multiple>
                                    @foreach($formateurs as $formateur)
                                        <option value="{{ $formateur->id }}" 
                                                ...
                                                {{ (is_array(old('formateurs')) && in_array($formateur->id, old('formateurs'))) ? 'selected' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateTrainerList() {
        ...
        const filteredChoices = allOptions.filter(opt => {
            // Toujours afficher ceux qui sont déjà sélectionnés
            if (opt.selected) return true;
            // Sinon filtrer par rôle
            return showAll || opt.role === roleFormateur;
        });

        choicesInstance.destroy();
        
        // Nettoyer le select original
    ...
    updateTrainerList(); // Initial call

    // Sync selected items back to allOptions
